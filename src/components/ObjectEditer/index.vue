<template>
  <div class="ObjectEditer">
    ...
    <div style="margin: 0px 0 10px 0">
      <el-button v-if="empty(info)" size="small" @click="showMock" type="primary">
        <i class="ifont icon-mock"></i>mock</el-button>
      <template v-if="editable">
        <el-button size="small" @click="importJson" type="primary">
          <i class="ifont icon-import"></i>导入数据</el-button>
        <el-button size="small" @click="exportdata" type="primary">
          <i class="ifont icon-export"></i>导出据到</el-button>
    ...
    <div @keydown.shift.up="changeFocus($event,-inputnum)" @keydown.shift.down="changeFocus($event,inputnum)" @keydown.shift.left="changeFocus($event,-1)" @keydown.shift.right="changeFocus($event,1)">
      <item :required="required" :editable="editable" :data="info" :projectId="projectId"></item>
    </div>
