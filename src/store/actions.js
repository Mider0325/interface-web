...
export const updataTheme = ({ commit }, data) => {
 ...
 * @param context
 */
export const changeActiveIndex = ({ state, commit }, data) => {
 ...
 * @param context
 */
export const changeNavIndex = ({ commit }, data) => {
 ...
 * @param context
 */
export const changeNavTwoIndex = ({ commit }, data) => {
